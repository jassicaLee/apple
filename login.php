...
?>
	...
	<table class="navbar" border="0" cellpadding="5" cellspacing="3">
		<tr>
			...
			<td><input type="text" name="loginUsername" value="<?php if (isset($_POST['loginUsername'])) {echo htmlspecialchars($_POST['loginUsername']);}else {echo $_COOKIE['pgadmin_user'];} ?>" size="24" /></td>
		</tr>
		<tr>
			<td><?php echo $lang['strpassword']; ?></td>
			<td><input id="loginPassword" type="password" name="loginPassword_<?php echo $md5_server; ?>" value="<?php echo $_COOKIE['pgadmin_pass'];?>" size="24" /></td>
		</tr>
	</table>
